...
import { MoveHorizontal, MoveVertical, ArrowRight } from "lucide-react";
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-1">
          Horizontal
          <MoveHorizontal size-2 className="text-[#F2B705]" />
          <span className="opacity-50 font-normal">|</span>
          Vertical
          <MoveVertical size-2 className="text-[#F2B705]" />
        </div>
      </div>
    );
  };
      ...
      <div className="p-6 grow flex flex-col justify-between space-y-3">
        ...
        <div className="pt-2 border-t border-slate-50 flex items-center justify-between mt-auto">
          <div className="space-y-0.5">
            ...
            {hasPromo ? (
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[7px] text-slate-500 font-medium block mt-0.5 uppercase tracking-wider">
                  Precio no incluye IVA
                </span>
              </div>
            ) : (
          ...
          <div className="flex gap-2">
            ...
            <a
              href={`/producto/${product.id}`}
              className="bg-[#F2B705] px-2 py-2 rounded-xl shadow-md text-[#013189] flex items-center gap-2 group-hover:bg-[#d9a404] transition-colors"
              title="Ver mas detalles del producto"
            >
              <span className="text-[8px] font-black uppercase tracking-widest">
                VER MAS
